...
// import com.smsgateway.HttpHelper
// import com.smsgateway.TelegramHelper
...
class SmsNativeModule(reactContext: ReactApplicationContext) : ReactContextBaseJavaModule(reactContext) {
    private val prefs: SharedPreferences = reactContext.getSharedPreferences("SmsConfig", Context.MODE_PRIVATE)

    override fun getName() = "SmsNativeModule"
